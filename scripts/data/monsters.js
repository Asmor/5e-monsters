(function() {
	...
	function MonstersList(alignments) {
...

		{
			name: "Animated Table",
			size: "Large", type: "Construct", 
			ac: 15, hp: 39, init: -1, cr: 2,
			alignment: alignments.unaligned,
			id: "0855a70f-ba7f-4e30-a584-cfa59be1eed3",
		},
		{
			name: "Centaur Mummy",
			size: "Large", type: "Undead", 
			ac: 13, hp: 85, init: 1, cr: 6,
			alignment: alignments.le,
			id: "96100b59-4807-4e18-abcb-de21528ae642",
		},
		{
			name: "Choker",
			size: "Small", type: "Aberration", 
			ac: 16, hp: 13, init: 2, cr: 1,
			alignment: alignments.ce,
			id: "8a3f9129-d373-451e-b8f3-ced663c2d754",
		},
		{
			name: "Deathlock Wight",
			size: "Medium", type: "Undead", 
			ac: 12, hp: 37, init: 2, cr: 3,
			alignment: alignments.ne,
			id: "4f5b3ea3-ac78-45e3-a226-6c3ef60b6c15",
		},
		{
			name: "Dread Warrior",
			size: "Medium", type: "Undead", 
			ac: 18, hp: 37, init: 0, cr: 1,
			alignment: alignments.ne,
			id: "4e8c2d21-858a-41c8-86e9-b1cf2c324baa",
		},
		{
			name: "Duergar Spy",
			size: "Medium", type: "Humanoid", tags: [ "Dwarf" ],
			ac: 15, hp: 33, init: 3, cr: 2,
			alignment: alignments.le,
			id: "a05d907e-787b-4b4c-8ada-0b0dd970af84",
		},
		{
			name: "Giant Crayfish",
			size: "Large", type: "Beast", 
			ac: 15, hp: 45, init: 1, cr: 2,
			alignment: alignments.unaligned,
			id: "8411c027-a31e-4859-b0ca-65fd3a6a64c8",
		},
		{
			name: "Giant Ice Toad",
			size: "Large", type: "Monstrosity", 
			ac: 14, hp: 52, init: 1, cr: 3,
			alignment: alignments.n,
			id: "4393e301-f4ca-4530-a4be-f3fab6d61479",
		},
		{
			name: "Giant Lightning Eel",
			size: "Large", type: "Beast", 
			ac: 13, hp: 42, init: 3, cr: 3,
			alignment: alignments.unaligned,
			id: "c51945ec-2e38-4269-852e-e52a7c9510da",
		},
		{
			name: "Giant Skeleton",
			size: "Huge", type: "Undead", 
			ac: 17, hp: 115, init: 0, cr: 7,
			alignment: alignments.ne,
			id: "3638bace-4250-4ec1-97f3-1e253e8feeb5",
		},
		{
			name: "Giant Subterranean Lizard",
			size: "Huge", type: "Beast", 
			ac: 14, hp: 66, init: -1, cr: 4,
			alignment: alignments.unaligned,
			id: "22ffc860-f4b8-4128-b2fb-42fd308728c5",
		},
		{
			name: "Greater Zombie",
			size: "Medium", type: "Undead", 
			ac: 15, hp: 97, init: 0, cr: 5,
			alignment: alignments.ne,
			id: "2a5bb149-69ba-42e2-99e7-862d4a1197ba",
		},
		{
			name: "Kalka-Kylla",
			size: "Large", type: "Monstrosity", unique: true,
			ac: 15, hp: 85, init: 1, cr: 3,
			alignment: alignments.n,
			id: "47e4ae88-edfc-4cc1-ab61-f36be1d6293b",
		},
		{
			name: "Kelpie",
			size: "Medium", type: "Plant", 
			ac: 14, hp: 67, init: 2, cr: 4,
			alignment: alignments.ne,
			id: "d3c2f1e1-beb5-40ef-a990-e951720af189",
		},
		{
			name: "Leucrotta",
			size: "Large", type: "Monstrosity", 
			ac: 14, hp: 67, init: 2, cr: 3,
			alignment: alignments.ce,
			id: "42921ee2-bcd9-4563-9c86-809079af569b",
		},
		{
			name: "Malformed Kraken",
			size: "Huge", type: "Monstrosity", unique: true,
			ac: 17, hp: 172, init: 0, cr: 10,
			alignment: alignments.ce,
			id: "c8a6a3f0-2ee7-4785-8962-39c4acbbf5d0",
		},
		{
			name: "Nereid",
			size: "Medium", type: "Fey", 
			ac: 13, hp: 44, init: 3, cr: 2,
			alignment: alignments.any_chaotic,
			id: "b7125ade-88a0-43c3-84b8-4b3daa877051",
		},
		{
			name: "Ooze Master",
			size: "Huge", type: "Undead", unique: true,
			ac: 9, hp: 138, init: -5, cr: 10,
			alignment: alignments.le,
			id: "12dc575b-58b0-4466-8906-828a818bea14",
		},
		{
			name: "Sea Lion",
			size: "Large", type: "Monstrosity", 
			ac: 15, hp: 90, init: 2, cr: 5,
			alignment: alignments.unaligned,
			id: "b1c1ce38-ab06-4c44-becf-51850d2e39b2",
		},
		{
			name: "Sharwyn Hucrele",
			size: "Medium", type: "Humanoid", tags: [ "Human" ], unique: true,
			ac: 16, hp: 13, init: 1, cr: "1/2",
			alignment: alignments.ne,
			id: "8a734438-bee6-4693-aa8c-a500e5fe4d33",
		},
		{
			name: "Sir Braford",
			size: "Medium", type: "Humanoid", tags: [ "Human" ], unique: true,
			ac: 18, hp: 19, init: -1, cr: "1/2",
			alignment: alignments.ne,
			id: "60df13db-3d5c-4d7d-a980-1d2402c93ac8",
		},
		{
			name: "Siren",
			size: "Medium", type: "Fey", 
			ac: 14, hp: 38, init: 4, cr: 3,
			alignment: alignments.cg,
			id: "a77d2fee-8fb6-47ae-9bd0-7fdcbaab0ef0",
		},
		{
			name: "Tarul Var",
			size: "Medium", type: "Undead", unique: true,
			ac: 16, hp: 105, init: 3, cr: 13,
			alignment: alignments.ne,
			legendary: true, 
			id: "ab165193-ec76-45ab-83e5-009a90cee15b",
		},
		{
			name: "Tecuziztecatl",
			size: "Large", type: "Monstrosity", unique: true,
			ac: 13, hp: 102, init: 0, cr: 4,
			alignment: alignments.n,
			id: "ee8ffb63-36c2-4826-907f-4d0e2ffb590f",
		},
		{
			name: "Thayan Apprentice",
			size: "Medium", type: "Humanoid", tags: [ "Human" ], 
			ac: 12, hp: 27, init: 2, cr: 2,
			alignment: alignments.non_good,
			id: "83c50b79-039c-47ea-aaef-2bbc26cc144d",
		},
		{
			name: "Thayan Warrior",
			size: "Medium", type: "Humanoid", tags: [ "Human" ], 
			ac: 16, hp: 52, init: 1, cr: 2,
			alignment: alignments.non_good,
			id: "4fd142a2-f48c-46d6-ab1a-a0ab4845ea90",
		},
		{
			name: "Thorn Slinger",
			size: "Large", type: "Plant", 
			ac: 11, hp: 32, init: 1, cr: "1/2",
			alignment: alignments.unaligned,
			id: "ae3b4ca1-eeae-4ffe-b9b1-df5c29e26544",
		},
		{
			name: "Vampiric Mist",
			size: "Medium", type: "Undead", 
			ac: 13, hp: 45, init: 3, cr: 3,
			alignment: alignments.ce,
			id: "83e32b85-664f-4b54-b9e0-9986056f2dd7",
		},
		{
			name: "White Maw",
			size: "Gargantuan", type: "Ooze", unique: true,
			ac: 5, hp: 217, init: -5, cr: 10,
			alignment: alignments.cn,
			id: "5dbf10f4-1638-441d-8157-e127a98a9b78",
		},
		{
			name: "Yusdrayl",
			size: "Small", type: "Humanoid", tags: [ "Kobold" ], unique: true,
			ac: 12, hp: 16, init: 2, cr: 1,
			alignment: alignments.le,
			id: "4456897b-e915-4845-b561-e17f939d8d97",
		},
