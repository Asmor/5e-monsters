...
define([
	...
	return [
		...
		{
			section: "Fungi", name: "Vegepygmy Commoner and Worker",
			size: "Small", type: "Plant", 
			ac: "12", hp: "10", init: "2", cr: "1/8",
			alignment: alignments.unaligned,
			environments: [ "underground" ],
		...
		{
			section: "Fungi", name: "Vegepygmy Guard",
			size: "Small", type: "Plant",
		...
		{
			section: "Fungi", name: "Vegepygmy Chief",
			size: "Medium", type: "Plant",
			ac: "14", hp: "60", init: "2", cr: "3",
			alignment: alignments.unaligned,
			environments: [ "underground" ],
