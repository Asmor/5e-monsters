...
define([
	...
	return [
		...
		{
			name: "Amphorons of Yothri: Worker",
			size: "Small", type: "Construct",
		...
		{
			name: "Amphorons of Yothri: Warrior",
			size: "Medium", type: "Construct",
		...
		{
			name: "Amphorons of Yothri: Juggernaut",
			size: "Large", type: "Construct",
		...
		{
			name: "Vegepygmy Commoner, Worker",
			size: "Medium", type: "Fiend",
			ac: "16", hp: "65", init: "3", cr: "0",
			alignment: alignments.le,
			environments: [],
